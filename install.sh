...
if [ "$(uname -m)" = "armv7l" ]; then
  echo ""
	echo "WARNING:"
	echo "The Zevs Blockchain requires a 64 bit OS and this is 32 bit armv7l"
	echo "For more information, see"
	echo "https://github.com/Zevs-Network/Zevs-blockchain/wiki/Raspberry-Pi"
	echo "Exiting."
	exit 1
fi
# Get submodules
...
python -m pip install --extra-index-url https://pypi.Zevs.net/simple/ miniupnpc==2.1
python -m pip install -e . --extra-index-url https://pypi.Zevs.net/simple/

echo ""
echo "Zevs blockchain install.sh complete."
echo "For assistance join us on Keybase in the #testnet chat channel:"
echo "https://keybase.io/team/Zevs_network.public"
echo ""
echo "Try the Quick Start Guide to running Zevs-blockchain:"
echo "https://github.com/Zevs-Network/Zevs-blockchain/wiki/Quick-Start-Guide"
echo ""
echo "To install the GUI type 'sh install-gui.sh' after '. ./activate'."
echo ""
echo "Type '. ./activate' and then 'Zevs init' to begin."
